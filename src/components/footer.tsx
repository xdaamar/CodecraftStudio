      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-8">
          ...
          <div className="flex flex-col">
            ...
            <ul className="mt-4 flex flex-col gap-3 text-sm font-medium text-slate-600">
              <li>
                <Link href="/" className="hover:text-blue-600 transition-colors">Home</Link>
              </li>
              <li>
                <Link href="/#portfolio" className="hover:text-blue-600 transition-colors">Portofolio</Link>
              </li>
              <li>
          ...
          <div className="flex flex-col">
            ...
            <ul className="mt-4 flex flex-col gap-4 text-sm font-medium text-slate-600">
              <li>
                <a
