...
export function PortfolioPreviewCard({ item }: { item: PortfolioItem }) {
  ...
  return (
    <motion.article
      ...
      className="flex min-w-[88%] shrink-0 snap-start flex-col justify-between rounded-[1.75rem] border border-slate-200/70 bg-gradient-to-b from-white to-slate-50/80 p-5 shadow-[0_12px_35px_rgba(15,23,42,0.06)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_45px_rgba(15,23,42,0.10)] sm:min-w-0 sm:w-[350px]"
    >
      <div>
