  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        {fullWidthCard && (
          <article className="mt-8 flex flex-col rounded-[2rem] border border-emerald-100 bg-gradient-to-r from-emerald-50 via-white to-blue-50 p-8 shadow-[0_10px_40px_rgba(15,23,42,0.05)] transition duration-300 sm:p-10">
