  ...
  return (
    <main className="w-full bg-surface py-12 sm:py-16 lg:py-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        ...
        {/* 2. Hero Detail */}
        <header className="rounded-[2rem] border border-black/5 bg-white p-6 shadow-2xs sm:p-10 lg:p-12">
          <MotionDiv variant="staggerContainer" className="flex flex-col">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-12">
          ...
          <div className="space-y-12 lg:col-span-8">
            ...
            <MotionDiv variant="fadeLeft">
              <section className="rounded-[2rem] border border-black/5 bg-white p-6 shadow-2xs sm:p-8">
            ...
            <section className="rounded-[2rem] border border-black/5 bg-white p-6 shadow-2xs sm:p-8">
              <MotionDiv variant="fadeUp">
                ...
                <p className="mt-2 text-sm text-muted sm:text-base">
                  Bukti dokumentasi pengujian performa, SEO, dan tampilan
                  responsif dari{' '}
                ...
                {project.gallery.map((img) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <p className="mt-1 text-xs text-muted">{img.desc}</p>
                    </div>
                  </MotionChild>
                ))}
              </MotionDiv>
          ...
          <div className="space-y-8 lg:col-span-4">
            ...
            <MotionDiv
              variant="staggerContainer"
              className="rounded-[2rem] border border-black/5 bg-white p-6 shadow-2xs"
            >
        ...
        {/* Bottom CTA */}
        <MotionDiv variant="scaleIn" className="mt-16">
          <div className="rounded-[2rem] border border-black/5 bg-white p-8 text-center shadow-sm sm:p-12">
            <h2 className="font-heading text-2xl font-bold tracking-tight text-text sm:text-3xl">
              Ingin membangun website sekelas {project.title}?
            </h2>
            <p className="mx-auto mt-3 max-w-xl text-base text-muted">
              Konsultasikan ide bisnis Anda secara langsung dengan tim Code Craft
              Studio. Free konsultasi 100%!
            </p>
